...
class TasksBloc extends HydratedBloc<TasksEvent, TasksState> {
  ...
  void _onAddTask(AddTask event, Emitter<TasksState> emit) {
    ...
    emit(TasksState(
      pendingTasks: List.from(state.pendingTasks)
        ..add(event.task), // adding of task logic here;
  ...
  void _onRemoveTask(RemoveTask event, Emitter<TasksState> emit) {
    ...
    emit(TasksState(
        ...
        removedTasks: List.from(
          (state.removedTasks)..add(event.task.copyWith(isDeleted: true)),
        )));
  }
  ...
  // hydratedbloc is used so that after quitting the app , the app doesnt reverts
  // to the iniatial state and the data is saved;
}
